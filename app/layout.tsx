...
export const metadata: Metadata = {
  title: 'KBFixer - All-in-One File Size Optimizer by OnePersonAI',
  description: 'Compress, resize, and optimize Image, PDF, DOCX, and PPT files locally in your browser with 100% Privacy. Powered by OnePersonAI (1% AI).',
  keywords: [
    'KBFixer',
    'OnePersonAI',
    '1% AI',
    ...
    'Image Compressor',
    'PDF Compressor 20kb',
    'Local File Optimizer',
    'Browser First AI Tools',
    'onepersonai.in',
  ...
  metadataBase: new URL('https://kbfixer.onepersonai.in'),
  alternates: {
    canonical: 'https://kbfixer.onepersonai.in',
  },
  icons: {
    icon: '/favicon.ico',
  },
  openGraph: {
    ...
    description: 'Compress & Resize Images, PDFs, DOCX & PPTs locally without uploading files to any server.',
    url: 'https://kbfixer.onepersonai.in',
    siteName: 'OnePersonAI Ecosystem',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
        height: 1200,
        alt: 'KBFixer by OnePersonAI',
      },
    ],
    locale: 'en_US',
    type: 'website',
  ...
  twitter: {
    ...
    description: 'Compress & Resize Images, PDFs, DOCX & PPTs 100% locally in your browser.',
...
export default function RootLayout({
  ...
  // JSON-LD Schema Markup for Google Brand Ranking
  const jsonLd = {
    ...
    description: 'A 100% browser-side private file size and image optimization web application built by OnePersonAI.',
  };
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className={`${spaceGrotesk.className} min-h-screen flex flex-col bg-white text-black antialiased`}>
        ...
        <footer className="border-t-4 border-black bg-white pt-12 pb-8 mt-auto">
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-black max-w-sm border-l-4 border-black pl-3">
                  Local, instant, and secure file optimization. Your files never leave your browser. Powered by <a href="https://onepersonai.in" target="_blank" rel="noreferrer" className="underline font-bold">OnePersonAI</a>.
                </p>
              </div>

              {/* Social Media Ecosystem Buttons (Pure Inline SVGs) */}
            ...
            <div className="text-xs sm:text-sm font-bold uppercase flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
              ...
              <span>
                Built by <a href="https://onepersonai.in" target="_blank" rel="noreferrer" className="underline decoration-2 underline-offset-4 hover:bg-black hover:text-white transition-colors">OnePersonAI</a>
              </span>
            </div>
          </div>
        </footer>
